...
import com.example.fanp.presentation.gps.protocol.GpsMainViewModel;
import com.example.fanp.presentation.gps.protocol.addtags.AddTagGpsViewmodel;
import com.example.fanp.presentation.lan.LanViewModel;
import com.example.fanp.presentation.login.MainLoginViewModel;
import com.example.fanp.presentation.login.forgetpassword.ForgetPassViewModel;
...
import com.example.fanp.presentation.newconvert.add.AddConvertProtoclViewModel;
...
import com.example.fanp.presentation.usermanagment.MainUserViewModel;
import com.example.fanp.presentation.usermanagment.adduser.AddUserViewModel;
...
public abstract class ViewModelModule {
    ...
    @Binds
    @IntoMap
    @ViewModelKey(AddConvertProtoclViewModel.class)
    public abstract ViewModel bindsaddConvertProtoclViewModel(AddConvertProtoclViewModel viewModel);
    ...
    public abstract ViewModel bindsMainLoginViewModel(MainLoginViewModel viewModel);


    @Binds
    @IntoMap
    @ViewModelKey(MainUserViewModel.class)
    public abstract ViewModel bindsMainUserViewModel(MainUserViewModel viewModel);

    @Binds
    @IntoMap
    @ViewModelKey(AddUserViewModel.class)
    public abstract ViewModel bindsAddUserViewModel(AddUserViewModel viewModel);


    @Binds
    @IntoMap
    @ViewModelKey(ForgetPassViewModel.class)
    public abstract ViewModel bindsForgetPassViewModel(ForgetPassViewModel viewModel);


    @Binds
    @IntoMap
    @ViewModelKey(GpsMainViewModel.class)
    public abstract ViewModel bindsGpsMainViewModel(GpsMainViewModel viewModel);


    @Binds
    @IntoMap
    @ViewModelKey(AddTagGpsViewmodel.class)
    public abstract ViewModel bindsAddTagGpsViewmodel(AddTagGpsViewmodel viewModel);
