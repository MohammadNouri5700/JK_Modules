...
import com.example.fanp.presentation.gps.protocol.addtags.AddTagGps;
import com.example.fanp.presentation.gps.protocol.gpsMain;
import com.example.fanp.presentation.lan.LanActivity;
import com.example.fanp.presentation.login.MainLogin;
import com.example.fanp.presentation.login.forgetpassword.ForgetPass;
import com.example.fanp.presentation.main.MainActivity;
import com.example.fanp.presentation.map.MainMap;
...
import com.example.fanp.presentation.newconvert.add.addConvertProtocol;
...
import com.example.fanp.presentation.usermanagment.MainUser;
import com.example.fanp.presentation.usermanagment.adduser.AddUser;
...
public abstract class ActivityBindingModule {
    ...
    @ActivityScope
    @ContributesAndroidInjector
    abstract addConvertProtocol addConvertProtocol();

    @ActivityScope
    @ContributesAndroidInjector
    abstract MainLogin mainLogin();

    @ActivityScope
    @ContributesAndroidInjector
    abstract MainUser mainUser();

    @ActivityScope
    @ContributesAndroidInjector
    abstract AddUser addUser();

    @ActivityScope
    @ContributesAndroidInjector
    abstract ForgetPass forgetPass();


    @ActivityScope
    @ContributesAndroidInjector
    abstract gpsMain gpsMain();

    @ActivityScope
    @ContributesAndroidInjector
    abstract AddTagGps addTagGps();

    @ActivityScope
    @ContributesAndroidInjector
    abstract MainMap mainMap();
}
